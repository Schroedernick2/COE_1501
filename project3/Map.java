...
public class Map extends JPanel {
	...
	public void edge(Edge edge) {
		...
		city1X = (int)((edge.getFirstCity().getX()/maxX)*width) ;
		city1Y = (int)((edge.getFirstCity().getY()/maxY)*height) ;
		city2X = (int)((edge.getSecondCity().getX()/maxX)*width) ;
		city2Y = (int)((edge.getSecondCity().getY()/maxY)*height) ;
